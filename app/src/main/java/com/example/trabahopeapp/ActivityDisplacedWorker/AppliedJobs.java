...
public class AppliedJobs extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    back_dashboard = findViewById(R.id.back_dashboard);
        ...
        final SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(AppliedJobs.this);

        back_dashboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AppliedJobs.this, DashboardActivity.class);
